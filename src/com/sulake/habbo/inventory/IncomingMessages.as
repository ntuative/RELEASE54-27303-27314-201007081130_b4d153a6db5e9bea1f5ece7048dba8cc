package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_569);
         _loc2_.refreshViews();
         var_14.notifyChangedEffects();
      }
      ...
      {
         var _loc2_:* = null;
         if(var_14.isInventoryCategoryInit(InventoryCategory.const_355))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_146);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_14.setInventoryCategoryInit(InventoryCategory.const_358);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_14.toggleInventorySubPage(InventorySubCategory.const_296);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:Array = _loc2_.method_17();
         ...
         _loc3_.updateView();
         var_14.setInventoryCategoryInit(InventoryCategory.const_262);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_355);
         var _loc4_:FurniModel = var_14.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
