package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1755:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_350 = param6;
         var_350.events.addEventListener(BadgeImageReadyEvent.const_139,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_984.length)
         {
            if(var_984[_loc2_] == param1)
            {
               var_984.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_295[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_295.length)
               {
                  if((var_295[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_295[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
