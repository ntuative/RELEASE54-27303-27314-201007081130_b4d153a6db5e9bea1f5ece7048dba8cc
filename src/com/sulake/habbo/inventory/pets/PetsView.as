package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_307:PetsGridItem;
      ...
      {
         if(var_593 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_593.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_307 != null)
         {
            var_307.setSelected(false);
         }
         var_307 = param1;
         if(var_307 != null)
         {
            var_307.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_307.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_593.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_593.getValue(param1.id) != null)
         {
            return;
         }
