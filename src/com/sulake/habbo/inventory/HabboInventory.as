package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_942:IRoomSession;
      ...
      private const const_1750:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_21 != null)
         {
            var_21.events.removeEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_382,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_104:
               var_942 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_382:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_49.getValue(InventoryCategory.const_569));
      }
      ...
      {
         return PetsModel(var_49.getValue(InventoryCategory.const_146));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_833));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1750);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_49.getValue(InventoryCategory.const_358));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_943.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_943.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_49.getValue(InventorySubCategory.const_296));
      }
      ...
      {
         return var_49.getValue(InventoryCategory.const_355) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1119 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_49.getValue(InventoryCategory.const_262));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionPropertyUpdateEvent.const_382,roomSessionEventHandler);
         ...
         var_49.add(InventoryCategory.const_355,_loc3_);
         ...
         var_49.add(InventoryCategory.const_146,_loc10_);
