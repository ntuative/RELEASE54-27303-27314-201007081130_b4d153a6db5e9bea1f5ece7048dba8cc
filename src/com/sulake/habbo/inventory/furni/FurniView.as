package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_486 = new Map();
         var_486.add(FurniModel.const_39,new FurniGridView(_model,FurniModel.const_39,_windowManager,_assetLibrary,_roomEngine));
         var_486.add(FurniModel.const_40,new FurniGridView(_model,FurniModel.const_40,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_54)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_356);
            }
         }
      }
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_39,FurniModel.const_40];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_339)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_808 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
