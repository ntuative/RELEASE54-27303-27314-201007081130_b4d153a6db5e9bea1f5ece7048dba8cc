package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1090:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_630 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_630.width;
         var_98 = var_630.height;
         var_1089 = param5;
         var_916 = param6;
         var_240 = Math.floor(var_1089 / _thumbWidth);
         var_20 = new BitmapData(var_1089,var_916);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_514 - 1)
         {
            ...
            var_20.fillRect(new Rectangle(0,0 - var_98,var_20.width,var_98),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_20.width,0 - var_98);
               _loc2_ = new Rectangle(0,0,var_20.width,0 - var_98);
               _loc11_.copyPixels(var_20,_loc2_,new Point(0,0),null,null,true);
               var_20 = _loc11_;
               --var_514;
            }
         }
         if(var_20.height < var_916)
         {
            _loc12_ = new BitmapData(var_20.width,var_916);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_630.width,var_630.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_630.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_630,var_630.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1090 != null)
         {
            _loc1_ = var_1090.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_514 = resolveRowCountFromList();
         if(var_514 == 0)
         {
            var_20 = new BitmapData(var_1089,var_916);
            return;
         }
         var_20 = new BitmapData(Math.max(var_240 * _thumbWidth,var_1089),Math.max(var_514 * var_98,var_916),true,16777215);
         var_20.fillRect(var_20.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_514)
         {
            _loc4_ = 0;
            while(_loc4_ < var_240)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_20.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_98),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_240 && var_20.height < _loc3_.y * var_98)
         {
            _loc2_ = new BitmapData(var_20.width,var_20.height + var_98);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_240 - 1),var_98);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_240 - 1),0,_thumbWidth,var_20.height);
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_98),null,null,true);
         _loc4_ = new Rectangle(0,var_98,_thumbWidth * (var_240 - 1),0 - var_98);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,var_98),null,null,true);
         var_20 = _loc2_;
      }
