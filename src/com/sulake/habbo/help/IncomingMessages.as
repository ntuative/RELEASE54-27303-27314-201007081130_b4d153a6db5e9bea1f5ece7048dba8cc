package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_25.tellUI(HabboHelpViewEnum.const_205,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_284,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_141);
      }
      ...
      {
         var_25.showUI(HabboHelpViewEnum.const_309);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_25.showUI(HabboHelpViewEnum.const_481);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_25.showUI(HabboHelpViewEnum.const_694);
         var_25.tellUI(HabboHelpViewEnum.const_694,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_330)
            {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_593);
      }
