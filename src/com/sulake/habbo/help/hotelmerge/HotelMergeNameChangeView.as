package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1579:uint = 13232628;
      
      private static var var_1987:uint = 11129827;
      ...
      private var var_912:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _controller.localization.registerParameter("help.tutorial.name.available","name",var_380);
      ...
      private function showSelectionView() : void
      {
         if(!var_664)
         {
            var_664 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_664)
            {
               return;
            }
            _window.content.addChild(var_664);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "confirm_name_button":
               _controller.changeName(var_380);
               break;
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1405 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_1014:
            ...
            case ChangeUserNameResultMessageEvent.var_1196:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1195:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1195 || param1 == ChangeUserNameResultMessageEvent.var_1196)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_912 = new NameSuggestionListRenderer(_controller);
         var _loc6_:int = var_912.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1579;
