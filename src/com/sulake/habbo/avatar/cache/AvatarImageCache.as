package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1479:int = 60000;
      ...
      private var var_901:IAvatarImage;
      ...
      {
         if(var_645 == param1 || var_645 == GeometryType.const_964 && param1 == GeometryType.const_968 || param1 == GeometryType.const_964 && var_645 == GeometryType.const_968)
         {
            var_645 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_765)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_484)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_82.getParts(param1,var_901.getFigure(),_loc6_,var_645,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_82.getCanvas(var_152,var_645);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1208[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_892 || _loc30_ == AvatarAction.const_488) && (_loc6_ == AvatarBodyPartType.const_245 || _loc6_ == AvatarBodyPartType.const_1189 || _loc6_ == AvatarBodyPartType.const_1410) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_152 == AvatarScaleType.const_49)
                  {
                     _loc31_.x += 65;
                  }
                  else
