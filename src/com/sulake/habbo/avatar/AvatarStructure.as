package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_874:AvatarActionManager;
      
      private var var_174:IAssetLibrary;
      
      private var var_873:IAssetLibrary;
      
      private var var_435:AvatarRenderManager;
      
      private var var_311:FigureData;
      
      private var var_617:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_611:String;
      
      private var var_1533:AvatarStructureDownloadSet;
      
      private var var_714:Dictionary;
      
      private var var_715:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_174 = param2;
         var_873 = param3;
         var_311 = new FigureData();
         var_412 = new PartSetsData();
         var_617 = new AnimationData();
         var_1533 = new AvatarStructureDownloadSet();
         var_715 = new AnimationManager();
         var_611 = param4;
         var_1532 = PartOffsetData.getInstance(param3);
      ...
      {
         return var_874.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_874.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_311.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_874.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_715.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_412.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1378[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_874.getDefaultAction();
         var _loc9_:Array = var_412.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_715.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_311.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_311.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_617.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_412.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_412.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_611 + " ready to go!");
         if(var_611 == AvatarType.const_71)
         {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_611)
         {
            case AvatarType.const_71:
               ...
               var_1533.add(new AvatarStructureDownload(var_174,_loc5_,var_311));
               break;
            case AvatarType.PET:
         }
         var_1533.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_715.getAnimation(param1);
      }
      ...
      {
         var_874 = new AvatarActionManager(var_174,var_611);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_714[param1] = new Dictionary();
         }
         if(var_714[param1][param2])
         {
            return var_714[param1][param2];
         }
         var_714[param1][param2] = var_311.getMandatorySetTypeIds(param1,param2);
         return var_714[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_311.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_873.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_873.getAssetByName("dance" + _loc1_).content as XML;
            var_715.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_873.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_873.getAssetByName("fx" + _loc1_).content as XML;
            var_715.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_311.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_311.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1532.loadOffsets(var_873);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_874.sortActions(param1);
      }
   }
}
