   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_246,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_169,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_225,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_157 == "")
         {
            _model.switchCategory(FigureData.const_169);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_jacket":
                  switchCategory(FigureData.const_246);
                  break;
               case "tab_shirt":
               ...
               case "tab_accessories":
                  ...
                  break;
               case "tab_prints":
                  switchCategory(FigureData.const_225);
            }
         }
