   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_213,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_223,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_207,_windowManager,_assetLibrary);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_hair":
                  ...
                  break;
               case "tab_hat":
                  switchCategory(FigureData.const_213);
                  break;
               case "tab_accessories":
                  switchCategory(FigureData.const_223);
                  break;
               case "tab_eyewear":
                  switchCategory(FigureData.const_207);
                  break;
               case "tab_masks":
