package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_824:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_823.width,var_823.height,true,0);
            _loc1_.bitmap.copyPixels(var_823,var_823.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1011.width,var_1011.height,true,0);
            _loc5_ = var_1011.clone();
            _loc5_.colorTransform(_loc5_.rect,var_824.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_825.width,var_825.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_825,var_825.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
