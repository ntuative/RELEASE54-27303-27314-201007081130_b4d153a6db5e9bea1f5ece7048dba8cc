package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_812 >= 0 && var_191.length > var_812)
         {
            _loc2_ = var_191[var_812];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_191.length > param1)
         {
            _loc3_ = var_191[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_218.length)
         {
            _loc7_ = _palettes[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > var_218[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_218[param2],param2);
         var_218[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_218[param1])
         {
            return null;
         }
      ...
      {
         return var_191[var_812] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_218 = new Array(param1.length);
         var _loc3_:int = 0;
