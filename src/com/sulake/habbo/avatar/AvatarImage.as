package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(_loc3_ != null)
         {
            if(false)
            {
               ...
               if(param2)
               {
                  return (var_434[_loc3_] as BitmapData).clone();
               }
               _image = var_434[_loc3_] as BitmapData;
               var_1114 = true;
               return _image;
            }
         }
         var _loc4_:AvatarImageCache = getCache();
         var _loc5_:AvatarCanvas = var_82.getCanvas(var_152,var_262.definition.geometryType);
         if(var_1114 || _image == null || _loc5_ != null && (_image.width != _loc5_.width || _image.height != _loc5_.height))
         {
            _loc5_ = var_82.getCanvas(var_152,var_262.definition.geometryType);
            if(_loc5_ == null)
            {
               return null;
            }
         ...
         while(_loc8_ >= 0)
         {
            ...
            _loc10_ = _loc4_.getImageContainer(_loc9_,var_500);
         ...
         if(_loc3_ != null)
         {
            var_434.add(_loc3_,_image.clone());
         }
         if(_image && param2)
         {
            return _image.clone();
      ...
      {
         if(var_1359 && false && var_94 == var_2427)
         {
            return var_94 + var_751 + var_500 % 4;
         }
         return null;
      }
