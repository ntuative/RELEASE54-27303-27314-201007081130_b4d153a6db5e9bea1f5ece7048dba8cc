package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class OutfitView
   {
      ...
      private var var_385:IBitmapWrapperWindow;
      ...
      public function OutfitView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:Boolean)
      {
         ...
         if(_window != null)
         {
            var_385 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
         if(!param3)
         {
      ...
      {
         var_385.bitmap = new BitmapData(var_385.width,var_385.height,true,16777215);
         var _loc2_:int = (0 - param1.width) / 2;
         var _loc3_:int = 0 - param1.height;
         var_385.bitmap.copyPixels(param1,param1.rect,new Point(_loc2_,_loc3_));
      }
