package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1163:Number = 90;
      
      private static const const_793:int = 50;
      
      private static const const_1133:Number = 25;
      ...
      private var var_1105:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1105 = param2;
         var_640 = new Timer(const_1133);
         var_640.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_521.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_521.splice(_loc3_,1);
            var_522.splice(_loc3_,1);
         }
         var_522.push(param1.name);
         var_521.push(param2);
         param1.addEventListener(WindowEvent.const_501,windowEventListener);
         param1.addEventListener(WindowEvent.const_192,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_521[var_522.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1105.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_320.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_320.splice(var_320.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1105.getIconLoc(param1.iconId);
      ...
      {
         return var_522[var_521.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_320[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_639[_loc3_] = new Array();
            }
            if(var_639[_loc3_].indexOf(param1) < 0)
            {
               var_639[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_793 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_793 || param1.desktop.height - param1.y < const_1134;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_522[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_639[_loc3_].length)
                  {
                     repositionWindow(var_639[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
