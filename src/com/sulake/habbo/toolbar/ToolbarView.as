package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1091:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_206 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_51,HabboWindowStyle.const_1001,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1091 = String(_loc7_.relocate_by_drag.@state) == "HabboFriendListCom_arrow_right_black_png";
         if(var_1091)
         {
         ...
         var_1329 = _loc7_.toolbar.@margin_bottom;
         var_1592 = _loc7_.toolbar.@min_group_margin;
         var_1591 = _loc7_.toolbar.@margin_to_extrabar;
         var_268 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_274,param1,param2,_window,var_268);
         createGroupsFromXmlList(_loc9_,var_631,param1,param2,var_206,var_268);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_274.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_631.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_132,var_515,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1592,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1329) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1592,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1329) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_132,var_515);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_515);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_132,var_515);
         }
      }
