package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_319.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_980,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_157,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_156,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_45,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_470,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_576,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_885,onHideWindowEvent);
         var_38 = true;
