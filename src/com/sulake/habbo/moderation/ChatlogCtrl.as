package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1556:IMessageComposer;
      ...
      {
         var_892 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_893 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_52 = IItemListWindow(var_54.findChildByName("chatline_list"));
         var_54.procedure = onWindow;
         var _loc1_:IWindow = var_54.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1556);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_892.clone());
      ...
      {
         if(param1.type != WindowEvent.const_43 || param2 != var_54)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_893.clone());
         _loc4_.color = var_1298[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
