package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_918:String = "issue_bundle_open";
      
      public static const const_602:String = "issue_bundle_my";
      
      public static const const_1016:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_143 = new Map();
         var_970 = new Map();
         var_661 = new IssueBrowser(this,var_59.windowManager,var_59.assets);
         var_777 = [];
         var_969 = [];
         var_1146 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1146.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_143)
         {
            switch(param1)
            {
               case const_918:
                  ...
                  break;
               case const_602:
                  if(_loc4_.state == IssueMessageData.const_463 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_777 = var_777.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_970.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_970.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1375)
         {
            var_159.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_143)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_970.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_970.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_147)
         {
            ...
            _loc8_ = var_969.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1146.remove(param1);
         var_1146.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_463 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1146.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_661 == null || !var_661.isOpen())
         {
            var_59.soundManager.playSound(HabboSoundTypesEnum.const_1046);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_970.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_143.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_463 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
