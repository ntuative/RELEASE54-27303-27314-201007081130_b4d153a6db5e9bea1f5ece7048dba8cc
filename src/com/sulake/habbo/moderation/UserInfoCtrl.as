package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_827:int = 86400;
      
      private static const const_826:int = 3600;
      
      private static const const_825:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_826)
         {
            return Math.round(param1 / const_825) + " mins ago";
         }
         if(param1 < 2 * const_827)
         {
            return Math.round(param1 / const_826) + " hours ago";
         }
         if(param1 < 2 * const_824)
         {
            return Math.round(param1 / const_827) + " days ago";
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_1006,_data.userId),_callerFrame,var_1194,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_1013.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_1013.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1441),_callerFrame,var_1194,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1194,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1441),_callerFrame,var_1194,false,true);
      }
