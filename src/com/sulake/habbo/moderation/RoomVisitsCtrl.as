package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2223.clone());
      ...
      {
         var_2223 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_52 = IItemListWindow(var_54.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1361;
      }
   }
}
