package com.sulake.habbo.ui
{
   ...
   public class FurnitureTrophyWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_606];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_606:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc6_ = _loc4_.getString(RoomObjectVariableEnum.const_109);
                     ...
                     _loc10_ = new RoomWidgetTrophyDataUpdateEvent(RoomWidgetTrophyDataUpdateEvent.const_726,_loc5_,_loc7_,_loc8_,_loc9_);
