package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_375:
               ...
               {
                  case RoomSessionQueueEvent.const_858:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_970:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_952) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_952) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1231) + 1;
                  }
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_621);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_970);
               break;
            case RoomWidgetRoomQueueMessage.const_621:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_858);
               break;
            case RoomWidgetRoomQueueMessage.const_681:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_209,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_375];
      }
