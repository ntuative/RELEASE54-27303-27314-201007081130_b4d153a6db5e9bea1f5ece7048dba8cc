package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_670,RoomWidgetEcotronBoxOpenMessage.const_761,RoomWidgetEcotronBoxOpenedMessage.const_1438];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_670:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_761:
