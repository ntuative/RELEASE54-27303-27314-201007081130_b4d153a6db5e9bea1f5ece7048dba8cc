package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_550:
            ...
            case RoomWidgetWaveMessage.const_768:
               ...
               break;
            case RoomWidgetDanceMessage.const_537:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_718:
               if(var_14 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_600:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_565:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_722:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_944)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_669:
               ...
               if(var_14 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_916:
                        _catalog.openCatalogPage(CatalogPageName.const_1389,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_866:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1281:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1428:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_625:
            case RoomWidgetStopEffectMessage.const_730:
            ...
            case RoomWidgetNavigateToRoomMessage.const_899:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_684:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_575:
               ...
               break;
            case RoomWidgetToolbarMessage.const_637:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_470,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_331:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_502));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_676:
            ...
            case RoomWidgetStoreSettingsMessage.const_647:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_769:
            ...
            case RoomWidgetAvatarEditorMessage.const_691:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_465));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_311:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_620));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_102:
               ...
               break;
            case HabboHelpTutorialEvent.const_456:
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_456,onHelpTutorialEvent);
         ...
         if(var_14 != null)
         {
            (var_14 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_833,onAvatarEffectsChanged);
            (var_14 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1036,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_456,onHelpTutorialEvent);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_537);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_718);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_600);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_565);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_625);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_669);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_722);
         _loc1_.push(RoomWidgetStopEffectMessage.const_730);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1334);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_899);
         _loc1_.push(RoomWidgetToolbarMessage.const_575);
         _loc1_.push(RoomWidgetToolbarMessage.const_637);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_331);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1347);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_960);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_684);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_550);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_676);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1237);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_647);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_769);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_691);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_311);
         return _loc1_;
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_980,HabboToolbarIconEnum.MEMENU);
