   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_152,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_139,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_150,onFigureUpdate);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_152,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_139,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_150,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_663);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_307);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_908);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1015);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_235)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_834)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_381);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_219)
               {
                  ...
                  _loc13_.method_7 = _container.roomSession.isRoomController;
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1317;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_842;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1357);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_682.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_49);
            var_682.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_738);
         _loc1_.push(RoomWidgetUserActionMessage.const_630);
         _loc1_.push(RoomWidgetUserActionMessage.const_546);
         _loc1_.push(RoomWidgetUserActionMessage.const_464);
         _loc1_.push(RoomWidgetUserActionMessage.const_616);
         _loc1_.push(RoomWidgetUserActionMessage.const_544);
         _loc1_.push(RoomWidgetUserActionMessage.const_728);
         _loc1_.push(RoomWidgetUserActionMessage.const_725);
         _loc1_.push(RoomWidgetUserActionMessage.const_690);
         _loc1_.push(RoomWidgetFurniActionMessage.const_268);
         _loc1_.push(RoomWidgetFurniActionMessage.const_659);
         _loc1_.push(RoomWidgetFurniActionMessage.const_678);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_646);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_543);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1387);
         _loc1_.push(RoomWidgetPetCommandMessage.const_760);
      ...
      public function dispose() : void
      {
         ...
         if(var_682 != null)
         {
            _loc1_ = var_682.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_682.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_578:
               ...
               break;
            case RoomWidgetUserActionMessage.const_738:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_906,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_546:
               ...
               break;
            case RoomWidgetUserActionMessage.const_464:
            ...
            case RoomWidgetUserActionMessage.const_544:
               ...
               break;
            case RoomWidgetUserActionMessage.const_728:
            ...
            case RoomWidgetUserActionMessage.const_511:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_646:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_543:
            ...
            case RoomWidgetPetCommandMessage.const_532:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_760:
