package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2034:IContainerButtonWindow;
      
      private var var_2037:IContainerButtonWindow;
      
      private var var_2036:IContainerButtonWindow;
      
      private var var_2035:IContainerButtonWindow;
      
      private var var_365:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_365 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_2037 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2036 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2034 = initButton("room_invite",onInviteButtonClick,param1);
         var_2035 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_365.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_365.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_27)
         {
            this.var_365.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2037,isEnableMinimailButton(_loc1_));
         setEnabled(var_2036,isEnableHomeButton(_loc1_));
         setEnabled(var_2034,isEnableInviteButton(_loc1_));
         setEnabled(var_2035,isEnableRemoveButton(_loc1_));
      }
