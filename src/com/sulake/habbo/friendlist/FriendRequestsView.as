package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1495:String = "no_reqs_info";
       
      
      private var var_1714:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1713:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_347 && _loc4_.state != FriendRequest.const_350)
            {
      ...
      {
         var_1714 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1713 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1713.procedure = onDismissAllButtonClick;
         var_1714.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_847)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1714,_loc1_);
         setEnabled(var_1713,_loc1_);
      }
