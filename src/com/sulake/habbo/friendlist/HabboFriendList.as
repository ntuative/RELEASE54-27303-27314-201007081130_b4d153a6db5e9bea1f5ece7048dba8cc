package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_853:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_432:FriendListTabs;
      ...
      private var var_1508:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_599:ISessionDataManager;
      
      private var var_352:FriendRequests;
      
      private var var_1777:int;
      
      var var_96:FriendCategories;
      
      private var var_1778:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_852:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1778 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_96 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1508 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_352.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_352.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_432.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_352 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_96.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_96.addCategory(new FriendCategory(FriendCategory.const_965,getText("friendlist.friends")));
         var_96.addCategory(new FriendCategory(FriendCategory.const_477,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_96.addFriend(new Friend(_loc4_));
         }
         var_432 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_487)
         {
            var_487 = new Timer(120000);
            var_487.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_487.start();
         }
         getBuddyRequests();
         registerListeners();
      ...
      override public function dispose() : void
      {
         ...
         {
            var_487.stop();
            var_487.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_487 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_853)
         {
            var_853.release(new IIDAvatarRenderManager());
            var_853 = null;
         }
         if(var_852)
         {
            var_852.release(new IIDHabboNotifications());
            var_852 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_599)
         {
            var_599.release(new IIDSessionDataManager());
            var_599 = null;
         }
         super.dispose();
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = _windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_36,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = var_96.getAllFriends();
      ...
      {
         var_96.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = var_134.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboFriendListCom_arrow_right_black_png";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_432.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_354));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1508.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_352.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_96.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_599.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_599.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_352.limit)
         {
            var_352.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_432.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_853.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_352.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_432.findTab(FriendListTab.const_85);
      ...
      {
         return var_134.getKey(param1,param1,param2);
      }
