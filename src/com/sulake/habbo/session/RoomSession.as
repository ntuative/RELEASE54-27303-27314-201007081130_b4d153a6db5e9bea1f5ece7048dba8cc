package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1115:UserDataManager;
      ...
      {
         if(var_38 == RoomSessionEvent.const_334 && _connection != null)
         {
            var_38 = RoomSessionEvent.const_98;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1115 as IUserDataManager;
      }
