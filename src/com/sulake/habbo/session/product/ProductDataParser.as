package com.sulake.habbo.session.product
{
   ...
   public class ProductDataParser extends EventDispatcher
   {
      ...
      public function ProductDataParser(param1:String, param2:Dictionary)
      {
         super();
         var_968 = param2;
         var_785 = new AssetLibrary("ProductDataParserAssetLib");
         var _loc3_:AssetLoaderStruct = var_785.loadAssetFromFile(param1,new URLRequest(param1),"text/plain");
