package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_978,_loc3_.status);
         }
      }
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_92.initializeTileMap(_loc7_,_loc8_);
         var _loc9_:* = -1;
         var _loc10_:* = -1;
         var _loc11_:* = 0;
         var _loc12_:* = 0;
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc20_ < _loc7_)
            {
               ...
               var_92.setTileHeight(_loc20_,_loc15_,_loc21_);
               _loc20_++;
            }
            _loc15_++;
         }
         if(!_loc13_)
         {
            var_92.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_);
         }
         ...
         var_92.initializeFromTileData(_loc16_);
         if(!_loc13_)
         {
            var_92.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_ + var_92.wallHeight);
         }
         _loc6_.scale = _loc3_.scale;
         _loc6_.initialize(_loc7_,_loc8_,var_92.floorHeight);
         ...
         while(_loc17_ >= 0)
         {
            ...
            while(_loc23_ >= 0)
            {
               _loc6_.setTileHeight(_loc23_,_loc17_,var_92.getTileHeight(_loc23_,_loc17_));
               _loc23_--;
            }
            _loc17_--;
         }
         var _loc18_:XML = var_92.getXML();
         var _loc19_:XML = <dimensions minX="{var_92.minX}" maxX="{var_92.maxX}" minY="{var_92.minY}" maxY="{var_92.maxY}"/>;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1039:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1047:
                     _loc10_ = "std";
               }
