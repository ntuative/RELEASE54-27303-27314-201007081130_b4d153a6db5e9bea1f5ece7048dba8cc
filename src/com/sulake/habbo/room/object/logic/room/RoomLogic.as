package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1549:int = 1500;
      
      private var var_1548:int = 255;
      
      private var var_1550:int = 255;
      
      private var var_1292:uint = 16777215;
      
      private var var_1073:uint = 16777215;
      
      protected var var_92:RoomPlaneParser = null;
      
      private var var_891:int = 0;
      
      private var var_1385:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_92.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_904,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_626,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_594,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_574,1);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_990,int(param1.bgOnly));
         var_1292 = _color;
         var_1548 = var_1385;
         var_1073 = _loc3_;
         var_1550 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_880:
               param2.setNumber(RoomObjectVariableEnum.const_594,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1056:
               param2.setNumber(RoomObjectVariableEnum.const_574,_loc3_);
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_404:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_197)
               {
                  _loc5_ = "null";
               }
               var_472.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_745:
               _loc4_ = var_472.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_472.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_863,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_558:
               param2.setString(RoomObjectVariableEnum.const_687,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_538:
               param2.setString(RoomObjectVariableEnum.const_711,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_597:
               param2.setString(RoomObjectVariableEnum.const_613,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_891)
         {
            ...
            {
               _loc7_ = var_1292 >> 16 & 255;
               _loc8_ = var_1292 >> 8 & 255;
               _loc9_ = var_1292 & 255;
               _loc10_ = var_1073 >> 16 & 255;
               _loc11_ = var_1073 >> 8 & 255;
               _loc12_ = var_1073 & 255;
               _loc13_ = (_loc2_ - var_891) / var_1549;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1548 + (var_1550 - var_1548) * _loc13_;
               _color = _loc3_;
               var_1385 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_626,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_92.planeCount)
         {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_92.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_92.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_92.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_92.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_92.getPlaneNormal(_loc5_);
         var _loc13_:int = var_92.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1319,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1382,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1312,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_145 || _loc13_ == RoomPlaneData.const_282)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
