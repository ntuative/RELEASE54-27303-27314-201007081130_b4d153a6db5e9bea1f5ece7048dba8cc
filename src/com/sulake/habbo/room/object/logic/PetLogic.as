   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPostureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_467,_loc3_.postureType);
            return;
         }
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            _loc4_ = param1 as RoomObjectAvatarUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_352,_loc4_.dirHead);
            return;
         }
         ...
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_389,Number(_loc8_.isSleeping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc12_ = _loc2_.getString(RoomObjectVariableEnum.const_173);
            _loc2_.setString(RoomObjectVariableEnum.const_173,_loc11_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1358,_loc11_.race);
            return;
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc8_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_232,_loc6_,_loc7_);
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_256,null);
            var_1154 = 0;
         }
         if(var_1153 > 0)
         {
