package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1673:int = 16777216;
      
      public static const const_1612:int = 1;
       
      
      private var var_2503:int = 69069;
      
      private var var_1333:int = 1;
      
      private var var_2502:int = 5;
      
      private var var_1596:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1596 * param2);
      }
      ...
      {
         var _loc1_:int = var_2503 * var_1333 + var_2502;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
