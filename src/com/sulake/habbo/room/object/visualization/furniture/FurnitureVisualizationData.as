package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_513:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_513 = var_273.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_513 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_273 != null)
         {
            ...
            {
               _loc1_ = var_273.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_273.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_273.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
