package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1128:String = "shore";
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = var_511 + 2;
         var _loc4_:int = var_625 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               var_510[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function resetBorders() : void
      {
         ...
         if(var_511 == 0 || var_625 == 0)
         {
            ...
            var_511 = _loc2_.getNumber(RoomObjectVariableEnum.const_295);
            var_625 = _loc2_.getNumber(RoomObjectVariableEnum.const_318);
         }
         var_366 = [];
         var_510 = [];
         var _loc1_:int = 0;
         while(_loc1_ < var_511 * 2 + var_625 * 2)
         {
            var_366.push(false);
            var_510.push(ShoreMaskCreatorUtility.const_73);
            _loc1_++;
         }
      }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               var_510[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc1_:int = var_511 + 2;
         var _loc2_:int = var_625 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(var_1966 == param1 && var_1967 == _direction)
         {
            return var_1569;
         }
         var_1966 = param1;
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1128)
            {
               var_1569 = _loc2_;
               break;
            }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(var_64,getSize(param3),var_366,var_510,assetCollection);
      }
