package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1470:int = 360;
      
      private var var_2370:int = 0;
      
      private var var_821:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1470 / 2) % 360 / var_1470;
         if(var_259.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_259.length)
         {
            _loc6_ = int(var_259.getKey(_loc5_)) * var_1470;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_259.getKey(_loc4_));
         }
         return const_1187;
      }
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_997);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_259.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_259 != null)
         {
            ...
            {
               _loc2_ = var_259.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_259.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_259.add(String(_loc7_),_loc3_);
            var_1469 = -1;
            var_821 = null;
            _loc5_++;
         }
