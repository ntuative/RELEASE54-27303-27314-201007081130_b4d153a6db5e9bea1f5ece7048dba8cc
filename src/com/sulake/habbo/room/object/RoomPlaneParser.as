package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_778:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_872;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_145,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_282,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_877);
         addPlane(RoomPlaneData.const_145,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_145,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _floorThickness) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_145,Vector3d.sum(param1,Vector3d.product(param3,-_floorThickness / param3.length)),Vector3d.product(param3,(param3.length + _floorThickness) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_877 / param2.length);
               addPlane(RoomPlaneData.const_145,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_778 = getFloorHeight(var_108);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_358 || param1 == var_359)
               {
                  _loc5_ = false;
                  _loc6_ = var_360;
