package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_810:String = "selection_arrow";
      
      private static const const_809:String = "tile_cursor";
      ...
      private static const const_1167:String = const_372;
      
      private static const const_1488:int = 0;
      
      private static const const_811:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_736:String = "RCL_LOADER_READY";
      ...
      private var var_1168:IEventDispatcher = null;
      
      private var var_1422:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_567 = [];
         _wallItems = [];
         var_2293 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2292 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_569.getValue(param1) as String;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_465 != null)
         {
            _loc2_ = var_465.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_350.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_188 != null && var_188.hasWorldType(const_297 + param1))
         {
            return var_188.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_387 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_387.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_676.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_372,const_525,ROOM_CONTENT,const_809,const_810];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_28 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(var_568.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2293.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_168 && _loc5_ != RoomObjectLogicEnum.const_143)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_566.getValue(param1) as String;
      ...
      {
         if(var_677.getValue(param1) != null)
         {
            return var_677.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_490,_loc5_);
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_466 != null)
         {
            _loc2_ = var_466.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1302);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_569.getValue(param1) as String;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_251;
         }
         return RoomObjectCategoryEnum.const_216;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2288)
         {
            ...
            if(var_1168 != null)
            {
               var_1168.dispatchEvent(new Event(const_736));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_188 != null)
         {
            return var_188.getWorldHeightScale(const_297 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_677.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_566.add(_loc3_,_loc4_);
               if(var_567.indexOf(_loc7_) < 0)
               {
                  var_567.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               var_569.add(_loc3_,_loc4_);
               if(_wallItems.indexOf(_loc7_) < 0)
               {
                  _wallItems.push(_loc7_);
               }
            }
            _loc8_ = var_568.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_568.remove(_loc7_);
               var_568.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1168 = param1;
         var_2294 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_2290 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_2289 = param2.getKey("public.room.dynamic.download.url","");
         var_2291 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_38 = const_811;
         initFurniData();
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_387.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_466 != null)
         {
            ...
            var_466.add(param1,param2);
         }
         if(var_465 != null)
         {
            var_465.remove(param2);
            var_465.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_168 && _loc5_ != RoomObjectVisualizationEnum.const_143)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_469.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_387.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_297 + param1) == RoomObjectCategoryEnum.const_60)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_188 = var_1422.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_489,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_188 != null)
         {
            return var_188.getWorldScale(const_297 + param1);
         }
         return 32;
      }
   }
