package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1073:String = "pet_inventory";
      
      private static const const_1072:String = "pixelbalance";
      
      private static const const_1075:String = "credits";
      
      private static const const_1076:String = "inventory";
      
      private static const const_1070:String = "friendlist";
      
      private static const const_1071:String = "selectfurni";
      
      private static const const_1074:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_595:ParkBusDialogManager;
      
      private var var_594:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_401:HabboNotificationViewManager;
      
      private var var_701:ClubEndingNotification;
      ...
      private var var_702:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_841);
         }
         var _loc6_:Map = var_841["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1416);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_702 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_198 == null)
         {
            return;
         }
         var_198.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_853)
         {
            return;
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_198.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_198.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_594)
         {
            var_594.release(new IIDHabboToolbar());
            var_594 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_82:
               ...
               break;
            case CatalogPageMessageProductData.const_208:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1434);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1746)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_925);
            var_1746 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1069:
               if(var_14 != null)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_262);
               }
               break;
            case const_1074:
               break;
            ...
            case const_1073:
               if(var_14)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_146);
               }
               break;
            case const_1071:
               break;
      ...
      {
         if(param1 != null && this.var_401 != null)
         {
            var_401.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_925,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_422.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1060,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_159 || param2.type == WindowEvent.const_609)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_401.method_6() && false)
         {
            var_401.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_595 == null)
         {
            var_595 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_595 != null)
         {
            var_595.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1032.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_422.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_78)
               {
                  _loc9_ = var_350.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_82)
               {
                  _loc9_ = var_350.getWallItemData(_loc8_.furniClassId);
               }
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1425,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_422.createAvatarImage(param2,AvatarScaleType.const_49);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1366)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_701 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_198 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_594 = IHabboToolbar(param2);
         var_594.events.addEventListener(HabboToolbarEvent.const_86,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_198.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_350.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_998);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_998);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_198.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_339;
            }
            if(param2 == 3002)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_86)
         {
            ...
            var_401 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_841["styles"],var_841["view"],var_594);
            ...
            registerUpdateReceiver(var_401,1);
            registerUpdateReceiver(this,2);
            var_350.events.addEventListener(BadgeImageReadyEvent.const_139,onBadgeImage);
            var_594.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
