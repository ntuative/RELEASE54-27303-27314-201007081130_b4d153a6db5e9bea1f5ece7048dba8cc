package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_578:ChooserView;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_615,onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_122,onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_641,onUpdateFurniChooser);
      ...
      {
         if(var_578 == null || !var_578.isOpen())
         {
            return;
         }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(var_578 == null)
         {
            var_578 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         var_578.populate(param1.items,param1.isAnyRoomController);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_615,onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_122,onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_641,onUpdateFurniChooser);
      }
   }
}
