package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_514:int = 16;
      
      private static const const_1177:int = 20;
      
      private static const const_363:int = 10;
      
      private static const const_1176:int = 40;
      ...
      private var var_457:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1181 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2341 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2340 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_813 = new Timer(1000,1);
         var_813.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_998 = new Timer(5000,1);
         var_998.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_51,HabboWindowStyle.const_36,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_117,onInputChanged);
         _window.addEventListener(WindowEvent.const_501,onWindowMoved);
         var_1445 = true;
         var_148 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2339 = _loc2_.width + const_514 + _loc6_.width + const_1177;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1176,_loc8_.width) + const_514);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1181 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_148 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_457);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_457);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_577);
