package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1082:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_577,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_130,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_577,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_130,onDoorbellHandled);
