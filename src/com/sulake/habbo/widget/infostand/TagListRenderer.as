package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1751:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1389 != null && var_1389.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_952 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_952 += param1.height + const_1752;
            return fit(param1);
         }
         param1.offset(_offsetX,var_952);
         _offsetX += param1.width + const_1751;
         return true;
      }
