package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1735:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1741:String = "level";
      
      private var var_113:IItemListWindow;
      
      private const const_1740:String = "energy";
      
      private var var_1307:Map;
      
      private const const_1736:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1734:uint = 3355443;
      
      private var var_252:IBorderWindow;
      
      private const const_1738:int = 158;
      
      private const const_1733:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_176:PetCommandTool;
      
      private const const_1739:uint = 11184810;
      
      private const const_1737:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_252 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_252 != null)
         {
            var_113 = var_252.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_252.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_252.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_113.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_113.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_113 == null || var_252 == null || var_65 == null)
         {
            return;
         }
         var_65.width = var_65.scrollableRegion.width;
         var_65.visible = false;
         var_113.height = var_113.scrollableRegion.height;
         var_252.height = NaN;
         _window.width = Math.max(var_252.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         if(var_176 == null)
         {
            var_176 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1307.getValue(var_681) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_176.showWindow(true);
            var_176.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set name(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_113.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_113.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_113.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1741,param1.level,param1.levelMax);
         updateStateElement(const_1737,param1.experience,param1.experienceMax);
         updateStateElement(const_1740,param1.energy,param1.energyMax);
         updateStateElement(const_1736,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_681 = param1.id;
         var_1307.remove(param1.id);
         var_1307.add(param1.id,param1);
         if(var_176 && var_176.isVisible() && param1.isOwnPet)
         {
            var_176.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_113.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_176.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_176 && var_176.getPetId() == var_681)
               {
                  var_176.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_464,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1738,const_1733,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1739);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1734);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1735);
         return _loc5_;
      }
