package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_259:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_632:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1223:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_38 = const_1223;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_547,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_38 = const_632;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_411,_id));
