package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_449,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_469,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_449,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_469,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_449:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_469:
               if(!var_255)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(var_255 || var_165 == -1 || !_controller)
         {
            return;
         }
         var_255 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_627,var_165);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_51,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1080,const_1079,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_213 != null)
         {
            _loc4_.caption = var_213;
         }
