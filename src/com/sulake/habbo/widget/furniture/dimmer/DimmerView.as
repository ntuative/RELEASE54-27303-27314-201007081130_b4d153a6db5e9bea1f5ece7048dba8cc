package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1079:Number = 100;
      ...
      private var var_579:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2351:int;
      
      private var var_392:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_239.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_239.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_51,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1080,const_1079,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_579 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_392 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_239 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_239.numTabItems)
         {
            _loc6_ = var_239.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_579 != null)
         {
            var_579.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_239.selector.getSelected();
         return var_239.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_392 != null)
         {
            var_392.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1184 = _loc2_.light;
         if(var_392 != null)
         {
            var_392.setValue(var_1184);
         }
         var_443 = colors.indexOf(_loc2_.color);
         if(var_579 != null)
         {
            var_579.setSelectedColorIndex(var_443);
         }
