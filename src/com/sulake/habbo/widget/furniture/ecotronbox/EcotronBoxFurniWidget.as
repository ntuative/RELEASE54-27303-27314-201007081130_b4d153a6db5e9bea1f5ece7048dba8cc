package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_761,var_165);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_51,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1080,const_1079,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_213 != null)
         {
            _loc6_.caption = var_213;
         }
