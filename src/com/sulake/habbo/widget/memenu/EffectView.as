   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_906 = _window.findChildByName("effect_hilite");
            var_906.visible = false;
         }
         var_905 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_907 = _window.findChildByName("loader_bar");
         if(var_907 != null)
         {
            var_457 = var_907.width;
            var_177.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_905 != null)
         {
            var_905.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_905.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
