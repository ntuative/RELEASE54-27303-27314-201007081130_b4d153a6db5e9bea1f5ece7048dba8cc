package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_794:uint = 11;
      
      private static var _instance:HabboTracking;
       
      
      private var var_245:LatencyTracker = null;
      ...
      private var var_927:LagWarningLogger = null;
      
      private var var_926:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_244 = new PerformanceTracker();
         var_525 = new FramerateTracker();
         var_245 = new LatencyTracker();
         var_927 = new LagWarningLogger();
         var_1350 = new Array(const_794);
         var _loc4_:int = 0;
         while(_loc4_ < const_794)
         {
            var_1350[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1439,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1215,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_692,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_914,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_748:
               trackLoginStep(HabboLoginTrackingStep.const_1279,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_229:
               trackLoginStep(HabboLoginTrackingStep.const_229);
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_244 != null)
            {
               var_244.connection = param1;
            }
            if(var_245 != null)
            {
               var_245.communication = _communication;
               var_245.connection = param1;
            }
            if(var_927 != null)
            {
               var_927.connection = param1;
            }
         }
      }
      ...
      {
         var_134 = IHabboConfigurationManager(param2);
         if(var_134)
         {
            Component(var_134).events.addEventListener(HabboConfigurationEvent.const_171,onConfigurationLoaded);
            if(var_245 != null)
            {
               var_245.configuration = var_134;
            }
            if(var_244 != null)
            {
               var_244.configuration = var_134;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_282.events.addEventListener(AdEvent.const_472,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2081)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1406);
            var_2081 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_914,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_692,String(true));
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_354:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_926)
            {
               var_926.release(new IIDHabboWindowManager());
               var_926 = null;
            }
            if(var_282)
            {
            ...
            if(var_184)
            {
               if(true)
               {
                  ...
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.const_354,onFriendlistTrackingEvent);
               }
            ...
            if(var_161)
            {
               if(true)
               {
                  var_161.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_161.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_161.release(new IIDHabboHelp());
               var_161 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_748,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_229,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_664,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_496,onHotelViewEvent);
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_134)
         {
            if(var_927 != null)
            {
               var_927.configure(var_134);
            }
            if(var_525 != null)
            {
               var_525.configure(var_134);
            }
            Component(var_134).events.removeEventListener(HabboConfigurationEvent.const_171,onConfigurationLoaded);
         }
      }
      ...
      {
         var_161 = param2 as IHabboHelp;
         var_161.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_161.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_867);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_867,onCoreRunning);
         }
      }
      ...
      {
         var_926 = IHabboWindowManager(param2);
         if(var_926)
         {
            Component(context).events.addEventListener(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT,method_5);
            Component(context).events.addEventListener(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER,method_5);
            Component(context).events.addEventListener(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP,method_5);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1109 > -1 && _loc2_ < var_1109)
         {
            ++var_1610;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1610);
         }
         if(var_1109 > -1 && _loc2_ - var_1109 > 15000)
         {
            ++var_1611;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1611);
         }
         var_1109 = _loc2_;
         if(var_244 != null)
         {
            var_244.update(param1);
         }
         if(var_245 != null)
         {
         ...
         if(var_525 != null)
         {
            var_525.trackUpdate(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_134 != null && !Boolean(var_134.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.const_354,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_134)
            {
               if(var_134.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_134.getKey("client.fatal.error.url");
                  ...
                  if(var_244 != null)
                  {
                     _loc4_["null"] = var_244.flashVersion;
                     _loc4_["null"] = var_244.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_664)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1276);
         }
         else if(param1.type == HabboHotelViewEvent.const_496)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1441);
         }
         else if(param1.type == HabboHotelViewEvent.const_64)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1213);
         }
      }
   }
}
