package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1246:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(false)
         {
            var_127[0].setSelected(true);
         }
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_562,0,var_408.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_408.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_408.getTabCount());
      ...
      {
         return var_408.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function closeConversation() : void
      {
         ...
         var _loc2_:int = var_127.indexOf(_loc1_);
         Util.remove(var_127,_loc1_);
         ...
         while(_loc2_ >= 0)
         {
            if(false)
            {
               var_127[_loc2_].setSelected(true);
               break;
            }
            _loc2_--;
         }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         var _loc2_:int = var_127.indexOf(param1);
         while(_startIndex + var_408.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_408.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_710,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_408.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1246++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_408.addMsgToView(_loc3_,param1);
         if(_loc2_ != var_127.length || _loc4_ != _loc3_.newMessageArrived)
         {
            var_408.refresh(false);
         }
      }
