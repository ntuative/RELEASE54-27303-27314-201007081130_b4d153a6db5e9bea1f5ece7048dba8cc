package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2300:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1682:ILogger;
      ...
      private var var_468:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2301)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_802 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_802);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         var_1171 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_229);
         connection.send(new VersionCheckMessageComposer(401,var_1424,var_2302));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1487,"/");
      ...
      {
         var _loc4_:IConnection = var_63.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_468.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_468.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2300);
      ...
      {
         var_802 = _habboConfiguration.getKey("sso.ticket",null);
         var_1424 = _habboConfiguration.getKey("flash.client.url","");
         var_2302 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_189 == null)
         {
         ...
         if(var_802 != null)
         {
            var_63.mode = HabboConnectionType.const_403;
            var_63.initConnection(HabboConnectionType.const_265);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1682 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_63.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            ...
            var_63.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_748);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2300 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_403:
               _loc6_ = "";
               ...
               var_1172 = _loc4_;
               var_189.loadBannerImage(_loc7_ + "?token=" + var_1172,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_987:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1350:
               var_678 = generateRandomHexString(30);
               var_468 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_468.init(var_678);
               _loc8_ = var_468.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1172);
         ...
         var_468 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_468.init(_loc14_);
            _loc15_ = var_468.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_63.mode = HabboConnectionType.const_987;
            }
         }
         var_63.initConnection(HabboConnectionType.const_265);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_171,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_104,onRoomSessionEnded);
      }
