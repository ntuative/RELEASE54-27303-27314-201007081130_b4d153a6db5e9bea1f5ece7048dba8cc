package com.sulake.habbo.communication.messages.parser.roomsettings
{
   ...
   public class RoomSettingsDataMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         var_109.allowPets = param1.readInteger() == 1;
         var_109.allowFoodConsume = param1.readInteger() == 1;
         var_109.allowWalkThrough = param1.readInteger() == 1;
         var_109.hideWalls = param1.readInteger() == 1;
         return true;
      }
