package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1601:ICoreWindowManager;
      ...
      {
         var_1601 = param2 as ICoreWindowManager;
         _window = var_1601.create("Logger::Output",HabboWindowType.const_103,WindowStyle.const_305,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_371 = var_1601.create("Logger::Output::Text",HabboWindowType.const_11,WindowStyle.const_305,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
