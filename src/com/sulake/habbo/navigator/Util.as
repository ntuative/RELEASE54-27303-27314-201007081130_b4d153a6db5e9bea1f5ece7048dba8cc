package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1703:CutToHeight = new CutToHeight();
      
      private static var var_1704:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1703.beforeSearch(param2,param1,param3);
         binarySearch(var_1703,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1704.beforeSearch(param2,param1,param3);
         binarySearch(var_1704,param2.length - 1);
      }
   }
}
