package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_512:IDropMenuWindow;
      
      private var var_2532:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         return Tabs.const_228;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_512 == null ? 0 : int(var_512.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_279,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_512 == null)
         {
            var_512 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_512.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
