package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1597:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_236,"-1",MainViewCtrl.const_570);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1597 == null)
         {
            ...
            var_1597 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1597.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
