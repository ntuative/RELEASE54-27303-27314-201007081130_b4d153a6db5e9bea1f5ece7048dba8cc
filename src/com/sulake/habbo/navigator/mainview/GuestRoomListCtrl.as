package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_396:IScrollbarWindow;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1393 != null)
         {
            _loc2_ = var_1393.tags[0];
            var_1393.color = getBgColor(_loc2_);
         }
         var_1393 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_396 = IScrollbarWindow(var_22.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_2189 - _loc2_.stageX);
         var_2189 = _loc2_.stageX;
         var_2188 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_134,null,0);
         refreshRoomName(param1,param2);
         var_900.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
