package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_863:RoomLayout;
      ...
      private function prepare() : void
      {
         ...
         var_1040 = new TextFieldManager(_navigator,ITextFieldWindow(var_22.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         var_1040.goBackToInitialState();
         var_1040.input.textBackgroundColor = 4294967295;
         var_863 = var_41[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_51,HabboWindowStyle.const_37,HabboWindowParam.const_67,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1040.getText();
      ...
      {
         var _loc1_:Boolean = var_1040.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_863.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1243 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1243 = true;
            _loc3_.y = 1;
