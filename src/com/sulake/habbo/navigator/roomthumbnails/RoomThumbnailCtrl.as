package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1589,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1590,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1589 = IButtonWindow(find("top_tab"));
         var_1590 = IButtonWindow(find("obj_tab"));
         var_1997 = IWindowContainer(find("tile_grid"));
         var_1996 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1589,onTopTabButton);
         Util.setProcDirectly(var_1590,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1997;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_413)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1996;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_51,HabboWindowStyle.const_37,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_36,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),onImgSel,_loc10_.id));
