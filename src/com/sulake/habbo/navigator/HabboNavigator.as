package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2529:Dictionary;
      ...
      private var var_501:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_432:Tabs;
      
      private var var_270:MainViewCtrl;
      
      private var var_1933:Array;
      
      private var var_1150:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_270 = new MainViewCtrl(this);
         var_501 = new RoomInfoViewCtrl(this);
         var_896 = new RoomCreateViewCtrl(this);
         var_1934 = new RoomThumbnailRenderer(this);
         var_1150 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_432 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_270.startSearch(Tabs.const_241,Tabs.const_321,param1);
         var_270.mainWindow.activate();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_134.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(_windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_36,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      {
         var_501.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_270.startSearch(Tabs.const_279,Tabs.const_228);
         var_432.getTab(Tabs.const_279).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_270.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
