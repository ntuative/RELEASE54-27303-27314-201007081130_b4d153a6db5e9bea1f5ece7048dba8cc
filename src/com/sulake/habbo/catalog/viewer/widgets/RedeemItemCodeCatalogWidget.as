package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1046:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1046 != null)
         {
            var_1046.removeEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_1046 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1046 != null)
         {
            var_1046.addEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         }
      }
