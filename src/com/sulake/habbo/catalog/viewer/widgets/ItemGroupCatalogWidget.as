package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_684[var_1189] as Array;
      ...
      {
         var _loc2_:Offer = var_684[var_1189][var_2362];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_428 || _loc1_.pricingModel == Offer.const_494)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_78)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1188.indexOf(_loc5_) == -1)
                        {
                           var_1188.push(_loc5_);
                           var_684.push(new Array());
                        }
                        _loc6_ = var_1188.indexOf(_loc5_);
                        (var_684[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_684)
         {
            if(var_2362 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2362] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1189 = var_1022.getGridItemIndex(param1.view);
