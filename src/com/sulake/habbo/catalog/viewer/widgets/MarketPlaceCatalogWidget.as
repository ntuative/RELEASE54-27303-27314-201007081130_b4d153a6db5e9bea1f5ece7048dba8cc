package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_974:MarketPlaceOfferData;
      
      private const const_1483:int = 1;
      
      private const const_1753:int = 40;
      ...
      private const const_1754:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_552)
         {
            ...
            var_552 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_552)
         {
            return;
         ...
         if(!var_451)
         {
            var_451 = new Timer(25);
            var_451.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_975 = 0;
         populateList();
         var_451.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_665)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_552 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_552.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_452.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_451)
         {
            var_451.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_451 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_975 >= var_665.length)
            {
               return true;
            }
            addListItem(var_665.getWithIndex(var_975));
            ++var_975;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_974.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_117)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_452));
            _loc7_.selection = 0;
         }
      }
