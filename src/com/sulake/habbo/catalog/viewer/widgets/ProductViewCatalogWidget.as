package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1311:IScrollbarWindow;
      
      protected var var_1455:XML;
      
      private var var_1312:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_620 != null)
         {
            var_620.visible = false;
            var_620.destroyGridItems();
         }
         if(var_1311 != null)
         {
            var_1311.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1450.text = "${" + _loc3_.name + "}";
            var_1451.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1450.text = "${" + _loc2_.localizationId + "}";
            var_1451.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_440:
                  _loc4_ = var_1312.clone();
                  if(var_620 != null)
                  {
                     var_620.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_620,var_1311,var_1455);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_208:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_281,AvatarAction.const_508);
                              _loc13_.appendAction(AvatarAction.const_491,_loc6_.productClassId);
      ...
      {
         var_1450 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1451 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1557 = new Point(var_85.x,var_85.y);
         var_620 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1311 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_620 == null)
         {
         ...
         var_1312 = _loc2_.content as BitmapData;
