package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1455:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_1000:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_815[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_1000 = new PrizeViewer();
         var_815 = recycler.getPrizeTable();
         if(var_815 == null)
         {
            return;
         }
         ...
         var_1454 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_815[0].prizes.length > 0)
         {
            select(var_815[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1454) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1455) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_1000.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
