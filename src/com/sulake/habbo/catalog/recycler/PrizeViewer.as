   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_266 != null && true)
         {
            ...
            var_266.bitmap = new BitmapData(var_266.width,var_266.height,true,16777215);
            var_266.bitmap.fillRect(var_266.bitmap.rect,16777215);
            _loc3_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_266.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         var_266 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
