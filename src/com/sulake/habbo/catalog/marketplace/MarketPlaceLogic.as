package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2347:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1637,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1957 || param1.furniTypeId != var_1961)
         {
            return;
         }
         var_2347 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_219.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1716,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_219.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_219.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_479)
            {
               var_219.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1845 = _loc3_.creditsWaiting;
         var_219 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_219.add(_loc4_.offerId,_loc6_);
         }
      ...
      {
         requestOffers(var_2346,var_2348,var_2329,var_2349);
      }
