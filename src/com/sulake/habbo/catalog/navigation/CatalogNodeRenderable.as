package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1140:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1637:XML;
      
      private static var var_1636:XML;
       
      
      private var var_2477:IWindowContainer;
      ...
      private var var_1638:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1638 == 4294967295)
            {
               var_1638 = _loc1_.color;
            }
            _loc1_.color = const_1140;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1251;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1637) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_52 = navigator.catalog.windowManager.buildFromXML(var_1636) as IItemListWindow;
         if(var_52 == null)
         {
