package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1026:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1525:uint = 1;
      ...
      protected var var_1202:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_1026:String = "";
      
      protected var var_2436:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_411:uint = 0;
      
      protected var var_2498:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_197.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_1026 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1026);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1202 & const_1026)
         {
            if(_loc3_ == 0)
            {
               if(var_197.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_197.getStructByIndex(_loc8_);
