package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1192:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_686:uint = 0;
      
      public static const const_566:String = "AssetLibraryReady";
      
      public static const const_1313:String = "AssetLibraryUnloaded";
      
      public static const const_489:String = "AssetLibraryLoaded";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_686;
         var_474 = new Dictionary(false);
         var_473 = new Dictionary(false);
         var_827 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_474)
         {
            _loc4_ = AssetTypeDeclaration(var_474[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_827)
         {
            delete var_827[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
         ...
         var_342 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1313));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_342 = true;
         dispatchEvent(new Event(AssetLibrary.const_489));
         dispatchEvent(new Event(AssetLibrary.const_566));
         if(var_583)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_473[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1045,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1030,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_938,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_473[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_474.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_474[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1192.splice(var_1192.indexOf(this),1);
            --var_686;
            var_473 = null;
            var_827 = null;
            var_151 = null;
      ...
      {
         return param1 < var_394.length ? getAssetByName(var_394[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_474[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_827[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_473[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_151)
            {
               if(var_151[_loc2_] == param1)
               {
                  var_394.splice(var_394.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_474[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
