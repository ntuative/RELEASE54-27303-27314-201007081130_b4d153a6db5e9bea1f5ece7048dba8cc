package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1521:String = "_TEMP";
      
      private static const const_1165:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1164:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1029:Dictionary;
      
      protected var var_1495:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1494:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_1029,var_1494);
         var_1495 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1164,"");
         return param1.replace(const_1165,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1494)
            {
               delete var_1494[_loc1_];
            }
            var_1495.dispose();
            var_1495 = null;
            _context = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "HabboFriendListCom_arrow_right_black_png";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "HabboFriendListCom_arrow_right_black_png";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "HabboFriendListCom_arrow_right_black_png";
