package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1154:String = "_CONTENT";
      
      private static const const_1153:String = "_SELECTOR";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1726 == null)
         {
            var_1726 = findChildByTag(const_1154) as IWindowContainer;
         }
         return var_1726;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1027 == null)
         {
            var_1027 = findChildByTag(const_1153) as ITabSelectorWindow;
            if(var_1027 != null)
            {
