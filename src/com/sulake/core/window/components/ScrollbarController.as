package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1078:String = "increment";
      
      private static const const_513:String = "slider_bar";
      
      private static const const_1077:String = "decrement";
      
      private static const const_772:String = "slider_track";
      ...
      protected var var_834:Number = 0.1;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_513:
         ...
         if(param2.type == WindowNotifyEvent.const_504)
         {
            if(var_23 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(const_772) as WindowController;
      }
      ...
      {
         return track.findChildByName(const_513) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_843 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_843 != null)
         {
            _loc1_ = findParentByName(var_843) as IScrollableWindow;
            if(_loc1_ == null && var_12 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_12).findChildByName(var_843) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function method_12(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_50)
         {
            ...
            else if(param2.name == const_772)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_513).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_933)
         {
