package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      {
         var _loc2_:IItemListWindow = _context.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_360,WindowStyle.const_305,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),listEventProc,null,numListItems,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IItemListWindow;
      ...
      public function method_18(param1:uint) : IWindow
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:int = 0;
