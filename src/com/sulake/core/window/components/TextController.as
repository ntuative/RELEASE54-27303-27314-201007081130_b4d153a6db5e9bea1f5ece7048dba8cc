package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2499:Rectangle = new Rectangle();
       
      
      protected var var_226:Boolean;
      ...
      {
         return new Rectangle(var_691 * maxScrollH,var_396 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_837)
         {
            context.removeLocalizationListener(var_347,this);
         }
         if(var_72 != null)
         {
            var_72.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_347 = param1;
         if(var_347.charAt(0) == "$" && var_347.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_347.slice(2,var_347.indexOf("}")),this);
            var_837 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1027,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_420,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_420,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_732,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_732,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("margin_left",var_72.left,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_top",var_72.top,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_right",var_72.right,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_72.bottom,PropertyStruct.const_59,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_732,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
