package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_840:IItemListWindow;
      
      private var var_349:IScrollbarWindow;
      
      private var var_1500:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_349)
         {
            var_349 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_349)
            {
               var_349.addEventListener(WindowEvent.const_293,scrollBarEventProc);
               var_349.addEventListener(WindowEvent.const_192,scrollBarEventProc);
            }
         }
         return var_349;
      }
      ...
      override public function dispose() : void
      {
         if(var_349)
         {
            var_349.removeEventListener(WindowEvent.const_293,scrollBarEventProc);
            var_349.removeEventListener(WindowEvent.const_192,scrollBarEventProc);
            var_349 = null;
         }
         if(var_840)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_192)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_840)
         {
            var_840 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_840;
      }
