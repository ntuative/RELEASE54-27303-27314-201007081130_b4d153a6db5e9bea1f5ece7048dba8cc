package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1446:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      private static var var_1706:Point = new Point();
      
      protected static const const_1068:String = "_COLORIZE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_403 = _loc13_.blend;
            var_590 = _loc13_.treshold;
            if(var_694 != _loc13_.background)
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_120,WindowParam.const_153);
         var _loc2_:* = !testParamFlag(WindowParam.const_135,WindowParam.const_142);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_285)
               {
                  _loc3_.width += _loc4_;
               }
      ...
      {
         var_694 = param1;
         var_591 = !!var_694 ? uint(var_591 | var_1493) : uint(var_591 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2342 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_915:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1436:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1327:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_504:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_359:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_19)
         {
            var_19 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_652,var_11);
            var_19.visible = var_356;
         }
         return var_19;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1020);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1182 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_359,this,param1));
         return param1;
      }
      ...
      {
         var_1493 = param1 & 4278190080;
         var_591 = !!var_694 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_75);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_753))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1028;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_162:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_182,WindowParam.const_153))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_164,WindowParam.const_142))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_12 != null)
                     {
                        _loc9_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_444))
                        {
                           var_12.width += 0 - 0;
                        }
                        ...
                        _param = _loc9_;
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_254,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_398:
                  _context.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_452);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_932,this,null));
                     if(var_12 != null)
                     {
               ...
               case WindowNotifyEvent.const_317:
                  if(param1 == this)
                  {
                     ...
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_220,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_445:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_919);
                  break;
               case WindowNotifyEvent.const_471:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_461:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_452);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_220:
                  ...
                  break;
               case WindowNotifyEvent.const_409:
                  var_12.getRegionProperties(null,var_334);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_359:
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1057,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function maximize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1005;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_724,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1182 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_376)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_984,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_683,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1381,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1404;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_173 && var_590 > 0)
         {
            if(!testParamFlag(WindowParam.const_30))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1706,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1706,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1409,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_65,false);
         _loc1_.type = WindowNotifyEvent.const_1364;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_12 != param1)
         {
            ...
            if(var_12 != null)
            {
               var_334 = var_12.rectangle.clone();
               var_58.x = var_11.x;
               var_58.y = var_11.y;
               var_58.width = var_11.width;
               var_58.height = var_11.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_504,this,var_12));
            }
            else
            {
               var_334.x = 0;
               ...
               var_334.width = 0;
               var_334.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_939,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,_param,_context,var_11,null,var_697,properties,var_693.concat(),_id) as WindowController;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_347;
         _loc2_.background = var_694;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_535;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_427;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1037,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(var_38 == WindowState.const_395)
         {
            return true;
         }
