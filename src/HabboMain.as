package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private var var_1209:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         var_1209 = HabboTracking.getInstance();
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_172,null);
         }
      }
         ...
         if(var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               if(_loc4_.fileName == "hh_human_fx.swf" || _loc4_.fileName == "hh_human_body.swf")
               {
                  if(var_1209 && true)
                  {
                     var_1209.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_972,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_972,error);
            Core.dispose();
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_172,null);
         }
         if(var_30)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_172,null);
         }
      }
